...
class Menu {
    ...
    public function add_admin_menu() {
        ...
        add_menu_page(__('WP AutoAgent', 'wp-autoagent'), __('WP AutoAgent', 'wp-autoagent'), 'manage_options', 'wp-autoagent', array($this, 'render_home_page'), 'dashicons-format-chat', 6);
